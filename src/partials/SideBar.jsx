...
function SideBar() {
    ...
    return (
        <div style={{ width: open ? "280px" : "64px", transition: ".30s ease" ,zIndex:"2000"}} className={"d-flex flex-column flex-shrink-0 bg-white vh-100 border-end collapsing sticky-top"}>
